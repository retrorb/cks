locals {
  questions_list="https://github.com/ViktorUJ/cks/blob/master/tasks/ckad/mock/03/README.md"
  solutions_scripts="https://github.com/ViktorUJ/cks/tree/master/tasks/ckad/mock/03/worker/files/solutions"
  solutions_video=""
  region = "eu-north-1"
