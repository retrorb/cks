locals {
  questions_list="https://github.com/retrorb/cks/blob/master/tasks/cka/mock/03/README.MD"
  solutions_scripts="https://github.com/retrorb/cks/tree/master/tasks/cka/mock/03/worker/files/solutions"
  solutions_video=""
  region = "eu-north-1"
