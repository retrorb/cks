...
inputs = {
  ...
  work_pc = {
    ...
    test_url          = "https://raw.githubusercontent.com/retrorb/cks/master/tasks/cka/mock/05/worker/files/tests.bats"
    task_script_url   = "https://raw.githubusercontent.com/retrorb/cks/master/tasks/cka/mock/05/worker/files/worker.sh"
    ssh = {
